...
- [ ] 05-01-PLAN.md — werf converge deploys API to minikube: Deployment, Service, ConfigMap, probes, resources (K8S-01–04, K8S-06, PERF-04)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 05-02-PLAN.md — Bundle kube-prometheus-stack: ServiceMonitor, Grafana dashboard, Chart.lock (D-01–04, D-10)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 05-03-PLAN.md — Zero-downtime rollout script, values-local, README k8s docs + human verify (K8S-05)
...
| 5. Kubernetes Deployment (via werf) | 0/3 | Not started | - |
